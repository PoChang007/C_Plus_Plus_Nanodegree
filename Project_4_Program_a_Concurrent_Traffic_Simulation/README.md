...
1. Clone this repo: `git clone https://github.com/PoChang007/C_Plus_Plus_Nanodegree.git`
2. `cd C_Plus_Plus_Nanodegree/Program_a_Concurrent_Traffic_Simulation`
3. Make a build directory in the project: `mkdir build && cd build`
